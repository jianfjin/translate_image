...
import { UploadedImage, Message, AppState, ProcessingStatus, GeneratedImage, OutputSettings } from './types';
...
const App = () => {
  ...
  const handleBatchDownload = () => {
    ...
    selected.forEach((img, i) => {
      // Trigger downloads with a slight delay to help browser batching without multiple prompts
    ...
    <div className="flex flex-col h-screen bg-white">
      ...
      <header className="h-16 border-b flex items-center justify-between px-6 bg-white z-10">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-xl font-bold">ProductLens Pro</h1>
        </div>
      </header>

      <main className="flex-1 flex overflow-hidden">
        <section className="w-80 border-r bg-white flex flex-col p-4 overflow-y-auto gap-6">
          <div>
